...
def to_iso(dt: datetime) -> str:
    """Convert datetime to ISO 8601 string (matching the real API format)."""
    return dt.isoformat()
...
def sample_journey_stations():
    ...
    return [
        make_station(
            ...
            sch_dep=to_iso(base), dep=to_iso(base + timedelta(minutes=2)),
        ),
        make_station(
            ...
            arr=to_iso(base + timedelta(hours=1, minutes=5)),
            dep=to_iso(base + timedelta(hours=1, minutes=7)),
        ),
        make_station(
            code="HBG", name="Harrisburg", status="Enroute",
            sch_arr=to_iso(base + timedelta(hours=3, minutes=30)),
            sch_dep=to_iso(base + timedelta(hours=3, minutes=35)),
            arr=to_iso(base + timedelta(hours=3, minutes=40)),
            dep=to_iso(base + timedelta(hours=3, minutes=45)),
        ),
        make_station(
            code="PHL", name="Philadelphia", status="",
            sch_arr=to_iso(base + timedelta(hours=5)),
            sch_dep=to_iso(base + timedelta(hours=5, minutes=5)),
        ),
        make_station(
            code="NYP", name="New York Penn", status="",
            sch_arr=to_iso(base + timedelta(hours=6, minutes=30)),
        ),
    ]
        ...
        return make_train(
            ...
            stations=[
                make_station(code="PGH", name="Pittsburgh", status="",
                             sch_dep=to_iso(sch_times["PGH_dep"])),
                make_station(code="GBG", name="Greensburg", status="",
                             sch_arr=to_iso(sch_times["GBG_arr"]),
                             sch_dep=to_iso(sch_times["GBG_dep"])),
                make_station(code="HBG", name="Harrisburg", status="",
                             sch_arr=to_iso(sch_times["HBG_arr"]),
                             sch_dep=to_iso(sch_times["HBG_dep"])),
                make_station(code="PHL", name="Philadelphia", status="",
                             sch_arr=to_iso(sch_times["PHL_arr"]),
                             sch_dep=to_iso(sch_times["PHL_dep"])),
                make_station(code="NYP", name="New York Penn", status="",
                             sch_arr=to_iso(sch_times["NYP_arr"])),
            ],
        )
        ...
        return make_train(
            ...
            stations=[
                make_station(code="PGH", name="Pittsburgh", status="Departed",
                             sch_dep=to_iso(sch_times["PGH_dep"]),
                             dep=to_iso(sch_times["PGH_dep"] + timedelta(minutes=1))),
                make_station(code="GBG", name="Greensburg", status="Enroute",
                             sch_arr=to_iso(sch_times["GBG_arr"]),
                             sch_dep=to_iso(sch_times["GBG_dep"]),
                             arr=to_iso(sch_times["GBG_arr"] + timedelta(minutes=2))),
                make_station(code="HBG", name="Harrisburg", status="",
                             sch_arr=to_iso(sch_times["HBG_arr"]),
                             sch_dep=to_iso(sch_times["HBG_dep"])),
                make_station(code="PHL", name="Philadelphia", status="",
        ...
        return make_train(
            ...
            stations=[
                ...
                make_station(code="GBG", name="Greensburg", status="Departed",
                             ...
                             sch_dep=to_iso(sch_times["GBG_dep"]),
                             arr=to_iso(sch_times["GBG_arr"] + timedelta(minutes=2)),
                             dep=to_iso(sch_times["GBG_dep"] + timedelta(minutes=3))),
                make_station(code="HBG", name="Harrisburg", status="Enroute",
                             sch_arr=to_iso(sch_times["HBG_arr"]),
                             sch_dep=to_iso(sch_times["HBG_dep"]),
                             arr=to_iso(sch_times["HBG_arr"] + timedelta(minutes=5))),
                make_station(code="PHL", name="Philadelphia", status="",
                             sch_arr=to_iso(sch_times["PHL_arr"]),
                             sch_dep=to_iso(sch_times["PHL_dep"])),
                make_station(code="NYP", name="New York Penn", status="",
        ...
        return make_train(
            ...
            stations=[
                ...
                make_station(code="GBG", name="Greensburg", status="Departed",
                             sch_arr=to_iso(sch_times["GBG_arr"]),
                             sch_dep=to_iso(sch_times["GBG_dep"]),
                             arr=to_iso(sch_times["GBG_arr"] + timedelta(minutes=15)),
                             dep=to_iso(sch_times["GBG_dep"] + timedelta(minutes=18))),
                make_station(code="HBG", name="Harrisburg", status="Enroute",
                             sch_arr=to_iso(sch_times["HBG_arr"]),
                             sch_dep=to_iso(sch_times["HBG_dep"]),
                             arr=to_iso(sch_times["HBG_arr"] + timedelta(minutes=25))),
                make_station(code="PHL", name="Philadelphia", status="",
                             sch_arr=to_iso(sch_times["PHL_arr"]),
                             sch_dep=to_iso(sch_times["PHL_dep"]),
                             arr=to_iso(sch_times["PHL_arr"] + timedelta(minutes=22))),
                make_station(code="NYP", name="New York Penn", status="",
                             sch_arr=to_iso(sch_times["NYP_arr"]),
                             arr=to_iso(sch_times["NYP_arr"] + timedelta(minutes=20))),
            ],
        )
        ...
        return make_train(
            ...
            stations=[
                ...
                make_station(code="GBG", name="Greensburg", status="Departed",
                             sch_arr=to_iso(sch_times["GBG_arr"]),
                             sch_dep=to_iso(sch_times["GBG_dep"]),
                             arr=to_iso(sch_times["GBG_arr"]),
                             dep=to_iso(sch_times["GBG_dep"])),
                make_station(code="HBG", name="Harrisburg", status="Departed",
                             sch_arr=to_iso(sch_times["HBG_arr"]),
                             sch_dep=to_iso(sch_times["HBG_dep"]),
                             arr=to_iso(sch_times["HBG_arr"]),
                             dep=to_iso(sch_times["HBG_dep"])),
                make_station(code="PHL", name="Philadelphia", status="Station",
                             sch_arr=to_iso(sch_times["PHL_arr"]),
                             sch_dep=to_iso(sch_times["PHL_dep"]),
                             arr=to_iso(sch_times["PHL_arr"] - timedelta(minutes=2))),
                make_station(code="NYP", name="New York Penn", status="",
                             sch_arr=to_iso(sch_times["NYP_arr"]),
                             arr=to_iso(sch_times["NYP_arr"])),
            ],
        )
        ...
        return make_train(
            ...
            stations=[
                ...
                make_station(code="PHL", name="Philadelphia", status="Departed",
                             sch_arr=to_iso(sch_times["PHL_arr"]),
                             sch_dep=to_iso(sch_times["PHL_dep"]),
                             arr=to_iso(sch_times["PHL_arr"]),
                             dep=to_iso(sch_times["PHL_dep"])),
